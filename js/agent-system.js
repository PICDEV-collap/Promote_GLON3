    ...
    return [
      {
        ...
        content: `สวัสดีครับ สนใจสั่งซื้อสลาก N3 กับร้าน "${shopName}" ใบละ 20 บาท ไม่มีเลขอั้น\n👉 สามารถแตะปุ่ม "สั่งซื้อสลาก N3" เพื่อเลือกเลขและจำนวนใบผ่านตารางออนไลน์ได้ทันทีครับ สแกนจ่ายผ่านแอปเป๋าตัง และสลากจะเข้าเมนู "สลากฯ ของฉัน" ทันที 100% ครับ`,
      ...
      },
      {
        ...
        content: `วิธีซื้อสลาก N3 ง่ายๆ ใน 3 ขั้นตอน:\n1. แตะสั่งซื้อผ่านตารางออนไลน์ เลือกเลขและจำนวนใบที่ต้องการ\n2. นำภาพ QR Code ชำระเงินไปเปิดสแกนในแอป "เป๋าตัง"\n3. เมื่อจ่ายสำเร็จ สลากจะเข้าเมนู "สลากฯ ของฉัน" ทันที 100% (ครั้งต่อไปซื้อผ่านเมนู "ซื้อผ่านร้านค้าที่เคยใช้บริการ" ได้เลยครับ!)`,
